...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$backendPath'; Write-Host '🖥️  Backend Server' -ForegroundColor Cyan; npm start"
...
Write-Host ""
Write-Host "⚠️  To stop: Close both PowerShell windows or press Ctrl+C in each" -ForegroundColor Yellow
